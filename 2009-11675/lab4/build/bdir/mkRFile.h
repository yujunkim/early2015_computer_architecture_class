...
namespace bluesim
{
  ...
  class MOD_mkRFile : public Module {
   ...
   private:
    ...
    tUInt8 DEF_bypassM_data_lat_whas____d252;
    tUInt8 DEF_bypassE_data_lat_whas____d251;
    tUInt8 DEF_IF_bypassM_enqP_lat_whas__1_THEN_bypassM_enqP__ETC___d247;
    tUInt8 DEF_IF_bypassE_enqP_lat_whas__0_THEN_bypassE_enqP__ETC___d243;
