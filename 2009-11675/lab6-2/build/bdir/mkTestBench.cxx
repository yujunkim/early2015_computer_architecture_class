...
namespace bluesim
{
  ...
  void MOD_mkTestBench::RL_run()
  {
    ...
    DEF_proc_cpuToHost_BITS_31_TO_0___d19 = primExtract32(32u, 68u, DEF_ab__h311, 32u, 31u, 32u, 0u);
    DEF_idx__h318 = primExtract8(4u, 68u, DEF_ab__h311, 32u, 67u, 32u, 64u);
    DEF_proc_cpuToHost_BITS_63_TO_32_2_EQ_0___d15 = DEF_data__h320 == 0u;
	...
	dollar_fwrite(this, "32,s,32", 2147483650u, &__str_literal_6, DEF_data__h320);
      if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
	dollar_fwrite(this, "32,s,32", 2147483650u, &__str_literal_7, DEF__read__h112);
      if (DEF_proc_cpuToHost_BITS_67_TO_64_0_EQ_14___d14)
	dollar_fwrite(this,
		      "32,s,32",
		      2147483650u,
